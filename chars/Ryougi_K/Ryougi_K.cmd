...
[State -1, Kara no Kyokai]
type = ChangeState
value = 4000
triggerall = command = "Kara_no_Kyoukai"
triggerall = power >= 3000
triggerall = statetype != A
...
type = ChangeState
value = 3100
triggerall = command = "Mujun_Rasen"
...
[State -1, Chokushi no Magan MAX]
type = ChangeState
value = 3000
triggerall = var(45) <= 0
triggerall = command = "Magan_MAX"
triggerall = power >= 2000
triggerall = statetype != A
...
[State -1, Chokushi no Magan]
type = ChangeState
value = 2000
triggerall = command = "Magan"
...
[State -1, Kasane Shouro]
type = ChangeState
value = 2100
triggerall = command = "Kasane_Shouro"
...
[State -1, Kasane Shouro Awakened]
type = ChangeState
value = 2110
triggerall = command = "Kasane_Shouro"
triggerall = Var(45) > 0
...
[State -1, Hari EX Awakened]
type = Changestate
value = 1130
triggerall = command = "Rekka_EX"
triggerall = StateType = A
triggerall = Var(45) > 0
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(20)
...
[State -1, Hari Medium Heavy]
type = ChangeState
value = 1110
triggerall = Statetype = A
triggerall = command = "Rekka_Medium" || command = "Rekka_Heavy"
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(20)
...
value = 1100
triggerall = Statetype = A
triggerall = command = "Rekka_Light"
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(20)
...
[State -1, VarSet]
type = VarSet
triggerall = Command = "Rekka_Light" || Command = "Rekka_Medium" || Command = "Rekka_Heavy"
...
type = VarSet
triggerall = Command = "Rekka_Light"
trigger1 = StateNo = 1001 || StateNo = 1030
V = 0
value = 1002

[State -1, Rekka Medium]
type = ChangeState
value = 1010
triggerall = Statetype != A
triggerall = command = "Rekka_Medium" || Command = "Rekka_Heavy"
...
[State -1, VarSet]
type = VarSet
triggerall = Command = "Rekka_Medium"
trigger1 = Stateno = 1001 || StateNo = 1030
V = 0
value = 1011
...
[State -1, VarSet]
type = VarSet
triggerall = Command = "Rekka_Heavy"
trigger1 = StateNo = 1001 || StateNo = 1030
V = 0
value = 1020
...
[State -1, VarSet]
type = VarSet
triggerall = Command = "Tsuki_Light"|| Command = "Tsuki_Medium" || Command = "Tsuki_Heavy"
trigger1 = Stateno = 1000 || StateNo = 1010
V = 0
value = 1030
...
[State -1, VarSet]
type = VarSet
triggerall = Command = "Tsuki_Light"
trigger1 = StateNo = 1000 || StateNo = 1010
V = 0
value = 1030
...
[State -1, VarSet]
type = VarSet
triggerall = Command = "Tsuki_Medium" || Command = "Tsuki_Heavy"
triggerall = StateType != A
trigger1 = StateNo = 1001 || StateNo = 1030
V = 0
value = 1032
...
value = 1220
triggerall = Statetype != A
triggerall = command = "Tsuki_Heavy"
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(20)

[State -1, Tsuki Medium]
type = ChangeState
value = 1210
triggerall = Statetype != A
triggerall = command = "Tsuki_Medium"
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(20)
...
trigger6 = (stateno = 215) && movecontact || (stateno = 415) && movecontact
