...
type = ChangeState
value = 3150
triggerall = command = "Low Tiger Cannon MAX" ;&& !numhelper(3060) && !numhelper(3160)
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 2000, power >= 1000)
triggerall = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
...
type = ChangeState
value = 3050
triggerall = command = "Tiger Cannon MAX" ;&& !numhelper(3060) && !numhelper(3160)
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 2000, power >= 1000)
triggerall = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
...
type = ChangeState
value = 3000
triggerall = command = "Tiger Cannon" ;&& !numhelper(3010) && !numhelper(3110)
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 1000, power >= 0)
triggerall = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
