...
type=ChangeState
value=3350
triggerall=!AILevel && RoundState=2 && !numhelper(3305) && !Numhelper(3355) && StateType != A &&var(20) <= 60 && power >= 2000&&command ="MaxGrandBuffrass"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
...
type=ChangeState
value=3200
triggerall=!AILevel && RoundState=2 && stateno!=3200 && StateType != A &&var(20) <= 60 && power >= 1000&&command ="AnOiMademoiselle"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Max Aurora]
...
type=ChangeState
value=3350
triggerall=AILevel && RoundState=2 && StateType != A && !numhelper(3305) && !Numhelper(3355) &&var(20)<=60&& power >= 2000 && random < (100 * (AIlevel ** 2 / 64.0))
...
value = 250
triggerall = AILevel && numenemy&&roundstate=2&&StateType != A&&P2statetype != A&&P2statetype != C&&P2statetype != L
trigger1 = (stateno = [240,249])|| (stateno = [440,449])&& movehit &&var(55)=1
trigger1 = random < 800
