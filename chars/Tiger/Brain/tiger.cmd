...
type = ChangeState
value = 3000
triggerall = var(7)!= 1 && stateno!=[3000,3049]
...
;===========================================================================
;---------------------------------------------------------------------------
;Shadow Hyper Claw (uses three super bar)
[State -1, HyperClaw]
type=Changestate
value=4000
triggerall = stateno!= 3000 && stateno!= 1251
triggerall= var(7)>=1 && roundstate=2 && statetype=S && stateno!=100 && ctrl && power>=3000
triggerall= p2statetype!=A && p2statetype!=A && p2statetype!=L && p2movetype!=H
trigger1= (p2bodydist x=[0,80]) && (p2bodydist y=[-25,25]) && random<250
trigger2= (p2stateno!=[120,155]) && (p2bodydist x=[0,36]) && (p2bodydist y=[-25,25]) && random<500
;---------------------------------------------------------------------------
;Destroyer (uses two super bar)
[State -1, Destroyer]
type=changestate
value=3060
triggerall = stateno!= 3060 && stateno!= 1251
...
;trigger3= stateno=3000 && anim=3000 && animelemtime(8)>=0 && random<75
trigger3= (stateno=[1000,1999]) && movehit && random<120 ;&& stateno!=3060
;---------------------------------------------------------------------------
;Shadow Tiger (uses one super bar)
[State -1, Shadow]
type=changestate
value=3050
triggerall = stateno!= 3050 && stateno!= 1251
triggerall = !numhelper(3051)
triggerall= var(7)>=1 && roundstate=2 && statetype!=A && power>=1000
triggerall= !(enemynear,ctrl) && (p2stateno!=[120,155]) && (p2statetype!=L)
triggerall= (p2bodydist x=[0,60]) && (p2dist y=[-50,0]) && (enemynear,vel y=[-7,1]) && (enemynear,vel x>-4)
trigger1= ctrl && random<50
trigger2= (stateno=220||stateno=225||stateno=250||stateno=255) && movehit && random<50
;trigger3= stateno=3000 && anim=3000 && animelemtime(8)>=0 && random<75
trigger3= (stateno=[1000,1999]) && movehit && random<100 ;&& stateno!=3060
;---------------------------------------------------------------------------
;Hyper Claw (uses one super bar)
[State -1, HyperClaw]
type=changestate
value=3000
triggerall = stateno!= 3000 && stateno!= 1251
...
type=Null
value=2500
triggerall= var(7)>=1 && roundstate=2 && statetype!=A && power>=750
...
trigger2= (stateno=[220,225]) && movehit && random<150
trigger2= (stateno=[250,255]) && movehit && random<150
trigger3= (stateno=[210,215]) && movehit && random<75
trigger3= (stateno=[240,245]) && movehit && random<75
;---------------------------------------------------------------------------
;Tiger Claw
[State -1, LightClaw]
type=changestate
value=1000
triggerall= var(7)>=1 && roundstate=2 && statetype!=A ;&& ctrl
triggerall= (p2stateno!=[120,155]) && (p2statetype!=L)
triggerall= (p2bodydist x=[0,70]) && (enemynear,vel y>-1) && (enemynear,vel x>-2)
trigger1= ctrl && random<50
trigger2= (stateno=[220,225]) && movehit && random<200
...
triggerall= var(7)>=1 && roundstate=2 && statetype!=A ;&& ctrl
triggerall= (p2stateno!=[120,155]) && (p2statetype!=L)
triggerall= (p2bodydist x=[70,90]) && (enemynear,vel y>-1) && (enemynear,vel x>-2)
trigger1= ctrl && random<50
trigger2= (stateno=[220,225]) && movehit && random<200
trigger2= (stateno=[250,255]) && movehit && random<200
trigger3= (stateno=[210,215]) && movehit && random<75
...
triggerall= var(7)>=1 && roundstate=2 && statetype!=A ;&& ctrl
triggerall= (p2stateno!=[120,155]) && (p2statetype!=L)
triggerall= (p2bodydist x=[90,115]) && (enemynear,vel y>-1) && (enemynear,vel x>-2)
trigger1= ctrl && random<50
trigger2= (stateno=[220,225]) && movehit && random<200
trigger2= (stateno=[250,255]) && movehit && random<200
trigger3= (stateno=[210,215]) && movehit && random<75
...
trigger2= (stateno=[220,225]) && movehit && p2bodydist x<25 && random<200
trigger2= (stateno=[250,255]) && movehit && p2bodydist x<25 && random<200
trigger3= (stateno=[210,215]) && movehit && p2bodydist x<25 && random<75
trigger3= (stateno=[240,245]) && movehit && p2bodydist x<25 && random<75
...
triggerall= (p2stateno!=[120,155]) && (p2statetype!=L)
triggerall= (p2bodydist x=[0,70]) && (enemynear,vel y>-1) && (enemynear,vel x>-2)
trigger1= stateno=1051 && movehit && anim=1051 && animelemtime(2)>=0 && random<250
trigger2= stateno=1061 && movehit && anim=1061 && animelemtime(5)>=0 && random<250
trigger3= stateno=1071 && movehit && anim=1071 && animelemtime(7)>=0 && random<250
;---------------------------------------------------------------------------
;Light Slaps
[State -1, LightSlaps]
type=changestate
...
triggerall= (p2stateno!=[120,155]) && (p2statetype!=L)
triggerall= (p2bodydist x=[0,70]) && (enemynear,vel y>-1) && (enemynear,vel x>-2)
trigger1= stateno=1100 && movehit && random<500
;---------------------------------------------------------------------------
;Finish Slaps
[State -1, FinishSlaps-1]
type=changestate
value=1102
triggerall= var(7)>=1 && roundstate=2 && statetype!=A
triggerall= (p2stateno!=[120,155]) && (p2statetype!=L)
triggerall= (p2bodydist x=[0,70]) && (enemynear,vel y>-1) && (enemynear,vel x>-2)
trigger1= stateno=1101 && movehit && random<250
trigger2= stateno=1111 && movehit && random<250
trigger3= stateno=1121 && movehit && random<250
;---------------------------------------------------------------------------
;Finish Slaps
[State -1, FinishSlaps-2]
type=changestate
value=1103
triggerall= var(7)>=1 && roundstate=2 && statetype!=A
triggerall= (p2stateno!=[120,155]) && (p2statetype!=L)
...
triggerall= (p2stateno!=[120,155]) && (p2statetype!=L)
triggerall= (p2bodydist x=[0,86]) && (enemynear,vel y>-1) && (enemynear,vel x>-2)
trigger1= stateno=1110 && movehit && random<500
;============================================================================
;---------------------------------------------------------------------------
;Fierce Slaps
[State -1, FierceSlaps]
...
triggerall= (p2stateno!=[120,155]) && (p2statetype!=L)
triggerall= (p2bodydist x=[0,103]) && (enemynear,vel y>-1) && (enemynear,vel x>-2)
trigger1= stateno=1120 && movehit && random<500
;---------------------------------------------------------------------------
;Tiger Back
[State -1, LightBack]
type=changestate
...
triggerall= var(7)>=1 && roundstate=2 && statetype!=A && ctrl
triggerall= (p2stateno!=[120,155]) && (p2statetype!=L)
triggerall= (p2bodydist x=[0,50]) && (enemynear,vel y>-1) && (enemynear,vel x>-2)
trigger1= ctrl && random<75
...
triggerall= var(7)>=1 && roundstate=2 && statetype!=A && ctrl
triggerall= (p2stateno!=[120,155]) && (p2statetype!=L)
triggerall= (p2bodydist x=[0,100]) && (enemynear,vel y>-1) && (enemynear,vel x>-2)
trigger1= ctrl && random<75
trigger2= (stateno=[220,225]) && movehit && random<300
trigger2= (stateno=[250,255]) && movehit && random<300
trigger3= (stateno=[210,215]) && movehit && random<75
trigger3= (stateno=[240,245]) && movehit && random<75
;---------------------------------------------------------------------------
;Finish Back
...
triggerall= (p2stateno!=[120,155]) && (p2statetype!=L)
triggerall= (p2bodydist x=[0,70]) && (enemynear,vel y>-1) && (enemynear,vel x>-2)
trigger1= stateno=1150 && movehit && random<500
trigger2= stateno=1160 && movehit && random<500
trigger3= stateno=1170 && movehit && random<500
;------------------------------------------------------------------------
[State -1, FlipKick]
type = ChangeState
value = 1200
...
trigger2= (stateno=[220,225]) && movehit && p2bodydist x<35 && random<200
trigger2= (stateno=[250,255]) && movehit && p2bodydist x<35 && random<200
trigger3= (stateno=[210,215]) && movehit && p2bodydist x<35 && random<75
trigger3= (stateno=[240,245]) && movehit && p2bodydist x<35 && random<75
trigger4= ctrl && p2bodydist x<100 && p2dist y<-120 && random<250
;trigger4= ctrl && prevstateno=1200 && random<200
;---------------------------------------------------------------------------
;Beatdown
...
type=changestate
value=1250
triggerall= var(7)>=1 && roundstate=2 && statetype=S && stateno!=100
triggerall= p2statetype!=A && p2statetype!=L
trigger1= ctrl && (p2bodydist x=[0,40]) && (p2bodydist y=[-25,25]) && random<50
trigger2= ctrl && (p2stateno!=[120,155]) && (p2bodydist x=[0,40]) && (p2bodydist y=[-25,25]) && random<50
trigger3= (stateno=[220,225]) && movehit && (p2bodydist x=[0,30]) && random<150
trigger3= (stateno=[250,255]) && movehit && (p2bodydist x=[0,30]) && random>150
trigger4= (stateno=[210,215]) && movehit && (p2bodydist x=[0,30]) && random<150
trigger4= (stateno=[240,245]) && movehit && (p2bodydist x=[0,30]) && random<150
;---------------------------------------------------
[State -1, Stomp]
type=changestate
value=1260
...
triggerall= (p2bodydist x=[0,34]) && (p2bodydist y=[-50,50]) && p2statetype!=L
trigger1= ctrl && random<100
;---------------------------------------------------------------------------
[State -1, SMP]
type=changestate
value=210
triggerall= var(7)>=1 && statetype!=A && roundstate=2
triggerall= (p2bodydist x=[0,60]) && (p2bodydist y=[-50,50]) && (p2statetype=S)
trigger1= ctrl && random<75
...
value=230
triggerall= var(7)>=1 && statetype!=A && roundstate=2
triggerall= (p2bodydist x=[0,44]) && (p2bodydist y=[-50,50]) && (p2statetype!=L) && (p2statetype!=A)
...
value=240
triggerall= var(7)>=1 && statetype!=A && roundstate=2
triggerall= (p2bodydist x=[0,45]) && (p2bodydist y=[-50,50]) && (p2statetype!=L) && (p2statetype!=C)
trigger1= ctrl && random<33
trigger2= (stateno=[200,205]) && movehit && random<500
trigger3= (stateno=[230,235]) && movehit && random<500
...
value=250
triggerall= var(7)>=1 && statetype!=A && roundstate=2
triggerall= (p2bodydist x=[0,80]) && (p2bodydist y=[-50,50]) && (p2statetype!=L) && (p2statetype!=C)
