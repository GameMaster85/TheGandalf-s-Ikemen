...
triggerall= (p2bodydist x=[0,50]) && (p2bodydist y=[-50,50]) && (enemynear,vel y>-1) && (enemynear,vel x>-2)
triggerall= p2stateno!=1405
trigger1= ctrl && p2movetype = H && p2bodydist x<50 && random<333
trigger2= (stateno=220||stateno=420) && movehit && random<500
trigger3= (stateno=240||stateno=250||stateno=410||stateno=440) && movehit && random<200
trigger4= (stateno=310) && movehit && random<333
trigger5= (stateno=1100) && movehit && random<500
;-------------------------------------------------------------------------------
[State -1, FlyingDragonKick]
type = ChangeState
value = 3050
