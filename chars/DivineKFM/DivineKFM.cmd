...
type = ChangeState
value = 1120
triggerall = command = "EX KF Upper"
triggerall = RoundState = 2 && StateType != A
...
[State -1, Strong KF Upper]
type = ChangeState
value = 1110
triggerall = command = "KF Upper2"
triggerall = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(5)

[State -1, Light+Medium KF Upper]
type = ChangeState
value = 1100
...
type = ChangeState
value = 1210
triggerall = command = "KF Blow2"
triggerall = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(5)

[State -1, Light+Medium KF Blow]
type = ChangeState
value = 1200
triggerall = command = "KF Blow"
triggerall = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(5)
