...
triggerall = p2bodydist x <= (const(size.xscale) * 48)
trigger1 = ctrl
trigger2 = var(6)
...
triggerall = command != "holdfwd" && command != "holdback"
triggerall = p2bodydist x <= (const(size.xscale) * 38)
trigger1 = ctrl
trigger2 = var(6)
...
trigger1 = (p2bodydist x = [0, 24]) && (p2bodydist y = [ -25, 0]) && random < (200 * (AIlevel ** 2 / 64.0))
trigger2 = (p2stateno = [120, 140]) && (p2bodydist x = [0, 32]) && (p2bodydist y = [ -25, 0]) && random < (50 * (AIlevel ** 2 / 64.0))
...
triggerall = roundstate = 2 && statetype != A
triggerall = numenemy >= 2 || var(14) < 1
triggerall = p2bodydist x > ceil(const(size.xscale) * 48)
triggerall = (p2bodydist x = [0, 50]) && (p2dist y = [0, 50]) && (p2statetype != C) && (p2statetype != L)
triggerall = (enemynear, const(size.head.pos.y) <= -40) || (enemynear, statetype = A)
trigger1 = ctrl && random < (25 * (AIlevel ** 2 / 64.0))
trigger2 = var(6) && (movecontact || var(18)) && random < (50 * (AIlevel ** 2 / 64.0))
...
triggerall = roundstate = 2 && statetype != A
triggerall = numenemy >= 2 || var(14) < 1
triggerall = p2bodydist x > ceil(const(size.xscale) * 38)
triggerall = (p2bodydist x = [0, 40]) && (p2dist y = [0, 50]) && (p2statetype != C) && (p2statetype != L)
triggerall = (enemynear, const(size.head.pos.y) <= -40) || (enemynear, statetype = A)
trigger1 = ctrl && random < (25 * (AIlevel ** 2 / 64.0))
trigger2 = var(6) && (movecontact || var(18)) && random < (25 * (AIlevel ** 2 / 64.0))
