...
triggerall=(p2bodydist x <= 65 && enemynear,statetype!=A && enemynear,statetype!=L)||((command="GekihekihaisuishouEX"||command="GekihekihaisuishouEX2"))&& power>=500
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
...
triggerall=AILevel && RoundState=2 && Numenemy && StateType != A && !var(11) 
triggerall=(p2bodydist x= [5,75]) && (p2bodydist y = [ -80, 5]) 
