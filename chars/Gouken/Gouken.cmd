...
type=ChangeState
value=3400
triggerall=AILevel && RoundState=2 && StateType != A &&var(20)<=0 && power >= 3000 && random < (400 * (AIlevel ** 2 / 64.0))
...
triggerall=AILevel && RoundState=2 && stateno!= 3320+50*var(11) && StateType != A &&var(20)<=60 && power >= 2000 && random < (350 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220])&&(enemynear,stateno!=[120,155])
...
triggerall=AILevel && RoundState=2 && stateno!= 3300+50*var(11) && StateType != A &&var(20)<=60 && power >= 1000 && random < (300 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220])&&(enemynear,stateno!=[120,155])
triggerall=(p2bodydist x =[-30,30])&&(p2bodydist y=[-90,5])&&(enemynear,statetype!=C)
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
...
type=ChangeState
value=3390
triggerall=AILevel && RoundState=2 && stateno!= 3390 && StateType = A && Pos y<=-10 &&var(20)<=60 && power >= 2000 && random < (320 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220])&&(enemynear,stateno!=[120,155])
...
type=ChangeState
value=3380
triggerall=AILevel && RoundState=2 && stateno!= 3380 && StateType = A && Pos y<=-10 &&var(20)<=60 && power >= 1000 && random < (220 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220])&&(enemynear,stateno!=[120,155])
triggerall=(p2bodydist x =[-30,30])&&(p2bodydist y=[-70,-5])&&(enemynear,statetype=A)
trigger1=ctrl
trigger2=var(6)|| var(7)
...
triggerall=AILevel && RoundState=2 && stateno!= 3280-30*var(11) && StateType != A &&var(20)<=60 && power >= 2000 && random < (150 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220])&&(enemynear,stateno!=[120,155])
...
triggerall=AILevel && RoundState=2 && stateno!= 3230-30*var(11) && StateType != A &&var(20)<=60 && power >= 1000 && random < (120 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220])&&(enemynear,stateno!=[120,155])
...
type=ChangeState
value=3150
triggerall=AILevel && RoundState=2 && stateno!= 3150 && StateType != A &&var(20)<=60 && power >= 2000 && random < (300 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220])&&(enemynear,stateno!=[120,155])
...
type=ChangeState
value=3100
triggerall=AILevel && RoundState=2 && stateno!= 3100 && StateType != A &&var(20)<=60 && power >= 1000 && random < (250 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220])&&(enemynear,stateno!=[120,155])
...
triggerall=AILevel && RoundState=2 && stateno!= 3050+30*var(11) && StateType != A && !numhelper(3005) && !Numhelper(3040) && !Numhelper(3055) &&var(20) <= 60 && power >= 2000
...
triggerall=AILevel && RoundState=2 && stateno!= 3000+30*var(11) && StateType != A && !numhelper(3005) && !Numhelper(3040) && !Numhelper(3055) &&var(20) <= 60 && power >= 1000
...
triggerall=AILevel && RoundState=2 && StateType != A && !var(11) && random < (180 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220])&&(enemynear,stateno!=[120,155])
...
triggerall=AILevel && RoundState=2 && StateType != A && var(11)=1 && random < (250 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype!=L)&&(enemynear,stateno!=[5100,5220])&&(enemynear,stateno!=[120,155])
triggerall=(p2bodydist x =[20,55])&&(p2bodydist y=[-110,5])&&(enemynear,statetype!=C)
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 810) && animelemtime(6)>1
;-------------------------------------------------------------------------
...
triggerall=AILevel && RoundState=2 && var(11)=0 && StateType != A && random < (150 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype!=L)&&(enemynear,stateno!=[5100,5220])&&(enemynear,stateno!=[120,155])
triggerall=(p2bodydist x =[45,180])&&(p2bodydist y=[-80,5])&&(enemynear,statetype!=A)
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
;----------------------------------------------------------------------
...
triggerall=AILevel && RoundState=2 && StateType != A && random < (70 * (AIlevel ** 2 / 64.0))
...
triggerall=(enemynear,statetype!=L)&&(enemynear,stateno!=[5100,5220])&&(enemynear,stateno!=[120,155])
triggerall=Ifelse(var(11)=0,(p2bodydist x =[-35,35]),(p2bodydist x =[25,175]))
...
triggerall=AILevel && RoundState=2 && StateType = A && Pos y <= -30 && random < (250 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype!=L)&&(enemynear,stateno!=[5100,5220])&&(enemynear,stateno!=[120,155])
...
triggerall=AILevel && RoundState=2 && StateType != A && random < (220 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype!=L)&&(enemynear,stateno!=[5100,5220])&&(enemynear,stateno!=[120,155])
triggerall=(p2bodydist x =[5,70])&&(p2bodydist y=[-80,5])&&(enemynear,statetype!=C)&&(enemynear,movetype!=A)
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 810) && animelemtime(6)>1
;-----------------------------------------------------------------
